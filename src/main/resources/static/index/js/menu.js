$(function(){
 ...
 $('.menu3').mouseenter(function(e){
   var nav1 ='<ul class="sf-menu" id="fh5co-primary-menu" style="width:200px"><li  style="float:none;display: inline;margin-left: 0; padding-left: 0;"><a href="index.html" class="fh5co-sub-ddown">最新2活动</a></li<li style="float:none"> <a href="portfolio.html" class="fh5co-sub-ddown">支持与服务</a></li> <li style="float:none">  <a href="services.html" class="fh5co-sub-ddown">解决方案</a>   </li><li style="float:none">  <a href="services.html" class="fh5co-sub-ddown">体验中心</a>    </li><li style="float:none">   <a href="services.html" class="fh5co-sub-ddown">下载中心</a>      </li>    <li style="float:none">                 <a href="services.html" class="fh5co-sub-ddown">合作伙伴</a>   </li> </ul>';
     $burger2.html(nav1);
    jsAnimateMenu2('open');
    });
