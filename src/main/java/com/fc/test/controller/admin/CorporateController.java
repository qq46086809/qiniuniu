...
public class CorporateController extends BaseController{
	...
	private String prefix = "admin/Corporate";
	
	
	@GetMapping("view")
	@RequiresPermissions("system:Corporate:view")
    public String view(Model model)
    {	
		
		setTitle(model, new TitleVo("公司动态", "公司动态", true,"欢迎进入公司动态", true, false));
        return prefix + "/list";
    }
	
	@PostMapping("list")
	@RequiresPermissions("system:Corporate:list")
	@ResponseBody
	...
	@PostMapping("add")
	@RequiresPermissions("system:Corporate:add")
	@ResponseBody
	 ...
	 */
	@PostMapping("remove")
	@RequiresPermissions("system:Corporate:remove")
	@ResponseBody
     ...
     * 修改保存用户
     */
    @RequiresPermissions("system:Corporate:edit")
    @PostMapping("/edit")
    @ResponseBody
     ...
     * 修改保存用户
     */
    @RequiresPermissions("system:Corporate:editPwd")
    @PostMapping("/editPwd")
    @ResponseBody
